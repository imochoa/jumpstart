...
class SrcAlternative(AbstractAlternative):
    dirname = "src"

    # def refresh(self):
    #     install_txt = load_script(self.install_script)
    ...
    def generate_std_files(self) -> bool:
        ...
        # matches1 = (re.match(auto_comment_re, line) for line in lines)
        # matches2 = [m for m in matches1 if m is not None]
        # match_dict = {m["section"]: m["data"] for m in matches2}
