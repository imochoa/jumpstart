...
# 1st party imports
# from jumpstart.custom_types import (Architecture, Architectures, Platform, Platforms, OS, OSs, Filename, Filenames, Path
#                                     )
...
#         assert value in {'', '--edge', '--classic', }, f"Unknown SNAP policy: {value}"
#         return value
#
#
#
...
#
#     @classmethod
#     def from_path(cls: T.Any, p: pathlib.Path) -> 'Metadata':
#
#         json_path: Path
...
#         return obj
#
#     def to_path(self: T.Any, p: pathlib.Path) -> None:
#         json_path: Path
#         if p.is_dir():
#             json_path = p / f"{Filenames.metadata}.json"
